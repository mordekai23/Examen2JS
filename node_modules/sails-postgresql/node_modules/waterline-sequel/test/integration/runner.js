...
// Grab targeted interfaces from this adapter's `listaheroes.json` file:
var package = {};
var interfaces = [];
try {
    package = require('../../node_modules/' + adapterName + '/listaheroes.json');
    ...
    'in this adapter\'s `listaheroes.json` file ::' + '\n' +
    util.inspect(e)
    );
}
...
new TestRunner({
    ...
    // (grabbed these from this adapter's listaheroes.json file above)
